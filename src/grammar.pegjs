...
VarToken        = kind:("var" / "const")    !IdentifierPart { return kind }
...
CallExpression
  ...
  / first:(
    ...
    {
      return buildTree(first, rest, function(result, element) {
        if (element.type === 'CallExpression' && element.arguments.async) {
          return {
            type: "YieldExpression",
            argument: {
              type: "CallExpression",
...
AsyncArguments
  = "(" __ args:(AsyncArgumentList __) ")" {
    ...
    if (asyncIndex !== -1) {
      result.splice(asyncIndex, 1);
      result.async = true;
      result.asyncIndex = asyncIndex;
    }
    return result;
  }

AsyncArgumentList
  = first:AsyncToken rest:(__ "," __ AsyncToken)* {
    return buildList(first, rest, 3);
  }
...
IterationStatement
  ...
  / ForToken __
    "(" __
    kind:VarToken __ declarations:VariableDeclarationListNoIn __ ";" __
    test:(Expression __)? ";" __
    update:(Expression __)?
    ")" __
    body:Statement
  ...
  / ForToken __
    "(" __
    kind:VarToken __ declarations:VariableDeclarationListNoIn __
    InToken __
    right:Expression __
    ")" __
    body:Statement
