module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c214 = function(kind) { return kind },
        peg$c215 = "void",
        peg$c216 = { type: "literal", value: "void", description: "\"void\"" },
        peg$c217 = "while",
        peg$c218 = { type: "literal", value: "while", description: "\"while\"" },
        peg$c219 = "with",
        peg$c220 = { type: "literal", value: "with", description: "\"with\"" },
        peg$c221 = ";",
        peg$c222 = { type: "literal", value: ";", description: "\";\"" },
        peg$c223 = "}",
        peg$c224 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c225 = function() { return { type: "ThisExpression" }; },
        peg$c226 = "(",
        peg$c227 = { type: "literal", value: "(", description: "\"(\"" },
        peg$c228 = ")",
        peg$c229 = { type: "literal", value: ")", description: "\")\"" },
        peg$c230 = function(expression) { return expression; },
        peg$c231 = function(elision) {
              return {
                type:     "ArrayExpression",
                elements: optionalList(extractOptional(elision, 0))
              };
            },
        peg$c232 = function(elements) {
              return {
                type:     "ArrayExpression",
                elements: elements
              };
        ...
        peg$c235 = function(elements, elision) {
              return {
                type:     "ArrayExpression",
                elements: elements.concat(optionalList(extractOptional(elision, 0)))
              };
            },
        peg$c236 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c237 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c238 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c239 = "{",
        peg$c240 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c241 = function() { return { type: "ObjectExpression", properties: [] }; },
        peg$c242 = function(properties) {
        ...
        peg$c268 = function(argument, operator) {
              return {
        ...
        peg$c273 = function(operator, argument) {
        ...
        peg$c282 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c283 = "*",
        ...
        peg$c356 = function(first, rest) { return buildList(first, rest, 1); },
        peg$c357 = function(kind, declarations) {
          return {
        ...
        peg$c366 = function(kind, declarations, test, update, body) {
              return {
                type:   "ForStatement",
                init:   {
                  type:         "VariableDeclaration",
        ...
        peg$c368 = function(kind, declarations, right, body) {
              return {
                type:  "ForInStatement",
                left:  {
                  type:         "VariableDeclaration",
    ...
    function peg$parseAsyncArguments() {
      var s0, s1, s2, s3, s4, s5;
    ...
    function peg$parseAsyncArgumentList() {
      var s0, s1, s2, s3, s4, s5, s6, s7;
